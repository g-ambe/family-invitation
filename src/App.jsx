     ...
     {/* Floating Leaves */}
        ...
        >
          {[...Array(5)].map((_, i) => {
            ...
            const randomDuration = 34 + Math.random() * 18
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  width: `${14 + i * 2}px`,
                  height: `${22 + i * 3}px`,
                  transform: `translateX(${tilt * 1.6}px) rotate(45deg)`,
                  borderRadius: "50% 0 50% 0",
                  background:
                    "linear-gradient(135deg, rgba(156,196,145,0.52), rgba(202,224,190,0.18))",
                  boxShadow:
                    "0 4px 12px rgba(126,169,116,0.12)",
                  filter: "blur(0.3px)",
